...
BOOT_ENTRIES = {
    "classic_68k": {
        ...
        "options": "root=LABEL=AMICACHY rw quiet splash amiprofile=classic_68k mitigations=off nowatchdog",
    },
    "ppc_nitro": {
        "filename": "02-ppc-nitro.conf",
        "title": "AmiCachyEnv - PPC Nitro",
        "options": "root=LABEL=AMICACHY rw quiet splash amiprofile=ppc_nitro mitigations=off nowatchdog",
    },
    "dev_station": {
        "filename": "03-dev-station.conf",
        "title": "AmiCachyEnv - Dev Station",
        "options": "root=LABEL=AMICACHY rw quiet splash amiprofile=dev_station",
    },
}
